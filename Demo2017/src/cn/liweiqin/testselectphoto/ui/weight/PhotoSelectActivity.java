...
import cn.liweiqin.testselectphoto.utils.Utils;
 ...
 */
public class PhotoSelectActivity extends Activity implements View.OnClickListener, AbsListView.OnItemClickListener, Callback {
     ...
     */
    private LinkedHashMap<String, PhotoInfo> mSelectPhotoMap = new LinkedHashMap<String, PhotoInfo>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPhotoListAdapter = new PhotoListAdapter(PhotoSelectActivity.this, mCurrentList, mSelectPhotoMap, WindowUtils.getScreenWidth(this));
    ...
    public void getPhotos() {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                List<PhotoFolderInfo> allFolderList = Utils.getAllPhotoFolder(PhotoSelectActivity.this, mSelectPhotoMap);
