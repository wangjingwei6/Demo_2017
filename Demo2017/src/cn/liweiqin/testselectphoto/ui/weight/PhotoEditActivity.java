...
public class PhotoEditActivity extends Activity {
    ...
    protected void takePhotoAction() {
        ...
        Log.i("qcs", "toFile == " + toFile.getAbsolutePath());
        Log.i("qcs", "uri == " + Uri.fromFile(toFile));
        if (Utils.mkdirs(takePhotoFolder)) {
    ...
    private void takeResult(PhotoInfo info) {
        photoInfo = info;
        Utils.display(PhotoEditActivity.this, info.getPhotoPath(), iv_take_photo, WindowUtils.getScreenWidth(this), WindowUtils.getScreenHeight(this));
    }
